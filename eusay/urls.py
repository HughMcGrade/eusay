...
urlpatterns = patterns('',
    ...
    url(r'^report_comment/(?P<comment_id>\d+)', eusay_views.report_comment, name="report_comment"),
    url(r'^report_proposal/(?P<proposal_id>\d+)', eusay_views.report_proposal, name="report_proposal"),
    url(r'^make_mod', eusay_views.make_mod),
    url(r'^make_staff', eusay_views.make_staff),
    url(r'^get_messages/', eusay_views.get_messages),
                       url(r'^hide_comment/(?P<comment_id>\d+)', eusay_views.hide_comment, name="hide_comment"),
                       url(r'^hide_proposal/(?P<proposal_id>\d+)', eusay_views.hide_proposal, name="hide_proposal"),
    ...
    url(r'^proposal/(?P<proposalId>\d+)/(?P<slug>[\w-]*)/respond/$',
        ...
        name="respond"),
                       url(r'^amend_proposal/(?P<proposal_id>\d+)', eusay_views.amend_proposal, name="amend_proposal"),

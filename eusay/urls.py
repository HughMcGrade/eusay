...
urlpatterns = patterns('',
    ...
    url(r'^api/proposals/(?P<id>[0-9]+)/$', views.ProposalDetail.as_view()),
    url(r'^api/proposals/(?P<id>[0-9]+)/comments/$', views.CommentList.as_view()),
    url(r'^api/comments/(?P<id>[0-9]+)/$', views.CommentDetail.as_view()),
